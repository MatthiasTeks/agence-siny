...
const Reseaux = (props: ReseauxType) => {
    return (
        <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ ease: "easeInOut", duration: 0.5, delay: props.delay}} viewport={{ once: true }}>
            <Box className="siny-developper" display="flex" flexDirection="row" justifyContent="start" alignItems="center" bg="#FFFFFE" position="relative" borderRadius="12px" my="1em" width={{sm: "300px", md: "400px", '2xl': "500px"}} height="70px">
                <Box display="flex" flexDirection="row" justifyContent="start" alignItems="center" pl="3em">
                    ...
                    />
                    <Heading color="blue.700" as="h4" size={{sm: "sm", lg: "md", '2xl': "lg"}} pl="2em">{props.title}</Heading>
                </Box>
            </Box>
        </motion.div>
    )
