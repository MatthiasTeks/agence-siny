...
const Pilotage = (props: PilotageType) => {
    return (
        <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ ease: "easeInOut", duration: 0.5, delay: props.delay}} viewport={{ once: true }}>
            <Box className="siny-developper" display="flex" flexDirection="column" justifyContent="center" alignItems="center" bg="#FFFFFE" position="relative" borderRadius="26px" mx="1em" width={{sm: "250px", '2xl': "300px"}} height={{sm: "250px", '2xl': "300px"}} mt="2em">
                <Image
                    src={props.image}
                    layout="fixed"
                    height={60}
